...
export function SupplierForm({ manager, products, suppliers, deleteSupplier, isStaff }: { manager: any, products: any[], suppliers: Supplier[], deleteSupplier: (id: string) => void, isStaff?: boolean }) {
  const {
