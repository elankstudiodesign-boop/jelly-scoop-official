...
export default function Live({ 
  ...
  return (
    <div className="space-y-6">
      ...
      {activeTab === 'CREATE' ? (
        <div className="flex flex-col lg:flex-row gap-4 lg:h-[calc(100dvh-180px)] lg:min-h-[600px]">
          {/* Mobile View Toggle */}
          ...
          <div className={`flex-1 flex-col bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden h-[calc(100dvh-260px)] min-h-[400px] lg:h-full lg:min-h-0 ${mobileView === 'PRODUCTS' ? 'flex' : 'hidden lg:flex'}`}>
          ...
          <div className={`w-full lg:w-[400px] xl:w-[450px] flex-col bg-white rounded-xl border border-slate-200 shadow-sm lg:overflow-hidden lg:h-full shrink-0 ${mobileView === 'CART' ? 'flex' : 'hidden lg:flex'}`}>
